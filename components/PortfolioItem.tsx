...
export default function PortfolioItem({ title, year, posterLink, description, videoLink, previewLink, visitLink, previewText }: PortfolioParams) {
        ...
        <>
            <div className='container lg:max-w-[960px] mx-auto px-7 py-20'>
                <div className='flex flex-col md:flex-row items-center text-center lg:text-left h-full'>
                    <div className='lg:basis-1/2 lg:p-0 mr-4'>
                    ...
                    <div className='lg:basis-1/2 mx-auto py-4'>
                        ...
                        <div className="flex flex-col md:flex-row">
                            <a href={previewLink} className="btn btn-primary lg:inline-block mb-4 md:mb-0 lg:mr-4">{previewText ?? "Preview"}</a>
